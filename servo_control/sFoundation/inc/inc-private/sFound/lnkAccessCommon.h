...
#define FACT_DFLT_XML_TXT "/Teknic User Settings.xml"
#define FACT_DFLT_INSTALL_XML_TXT "C:/Program Files (x86)/Teknic/Common/Teknic User Settings.xml"
#define FACT_DFLT_DEV_XML_TXT "C:/GIT/sFoundation/Teknic User Settings.xml"
...
public:
	...
	CCCriticalSection onlineOfflineLock;        // Initialization critical section
	...
	// functions and prevents extraneous and premature "online" signaling.
	int16 Initializing;
...
private:
	...
	// Set when halted
	bool m_halted;
    // Last-seen state of the global stop input
    bool m_lastGlobalStopState;
...
public:
	...
	scopemode DataAcqMode[MN_API_MAX_NODES];
