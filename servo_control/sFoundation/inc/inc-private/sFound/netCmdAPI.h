...
MN_EXPORT cnErrCode MN_DECL netEnterDataAcqModeEx(
	multiaddr theMultiAddr,
	double *startTime,
	scopemode theMode);
...
//----------------------------------
// Get the node's feature access level.
...
MN_EXPORT cnErrCode MN_DECL netParamCheckForDflts(
	multiaddr theMultiAddr);

MN_EXPORT cnErrCode MN_DECL netCloseUserSettingsXML();

MN_EXPORT cnErrCode MN_DECL netOpenUserSettingsXML(
	char *pFilePath);
