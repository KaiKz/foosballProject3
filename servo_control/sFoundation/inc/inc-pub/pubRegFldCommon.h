...
// 
// COPYRIGHT NOTICE:
//      (C)Copyright 2010-2019  Teknic, Inc.  All rights reserved.
//
...
typedef struct PACK_BYTES _commonAlertFlds {
    ...
    */
    ...
    /**
        \brief Internal Firmware Error 1.

        Internal Firmware Error 1.
    ...
    */
    ...
    /**
        ...
        - Replace node
    */
    unsigned FwInvalidConfiguration : 1; /* 6 */ // Invalid configuration
    /** \cond INTERNAL_DOC **/
    ...
    */
    ...
    /**
        ...
        not be able to communicate with this node. This condition is stored
        in internal log for factory use.
...
typedef enum _mnHLFBmodes {
    ...
    HLFB_ASG_LATCHED,               ///<  9 All Systems Go/Latch
    HLFB_TORQUE_ASG_LATCHED         ///<  10 Torque/ASG Latched, 5%=-100, 95%=100
} mnHLFBmodes;
//                                                                            *
//*****************************************************************************
