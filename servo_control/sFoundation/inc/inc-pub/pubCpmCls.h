...
private:
    ...
    void ParameterReloadDefault(nodeparam index);

    void SetParameterRaw(nodeparam index, packetbuf* packetBuffer);
    void GetParameterRaw(nodeparam index, packetbuf* packetBuffer);
...
private:
    ...
    CPMstring m_motorFilename;
    CPMstring m_userID;
    CPMstring m_userDesc;
...
public:
    ...
    **/
    ...
    size_t MoveVelStart(double target, bool isTriggered);
...
/**
    ...
    \note This is not exported to prevent the end-user from creating instances
    in DLL.
**/
...
private:
    ...
    bool GetNextNetChange(NetworkChanges& pNetChange);
