...
/**
    ...
    @{
**/
//      The ISC registers are defined with an extra layer for backwards
...
typedef struct PACK_BYTES _iscHwConfigFlds
{
    ...
    **/
#ifdef _MSC_VER
    BFld MotorType : 3;                          //  0-2
#else
    motorTypes MotorType : 3;                    //  0-2
#endif
    /**
...
**/
typedef union PACK_BYTES _iscHwConfigReg {
    ...
    tBOOL UsingCommStateChk() {
        ...
        STATIC_ASSERT((iscHwConfigFlds::CSM_NO_STATE_CHECK 
                       & iscHwConfigFlds::CSM_SENSORLESS_WITH_DAMPING
                       & iscHwConfigFlds::CSM_SENSORLESS_NO_DAMPING 
                       & iscHwConfigFlds::CSM_SENSORLESS_DAMPING_DIST_CHK
                       & iscHwConfigFlds::CSM_SENSORLESS_NO_DAMP_DIST_CHK 
                       & 0x4) != 0);
    ...
    tBOOL UsingCommThermalChk() {
        ...
        STATIC_ASSERT(((iscHwConfigFlds::CSM_STATE_SEQ_THERMAL 
                        | iscHwConfigFlds::CSM_STATE_THERMAL) & 0x1) == 0);
...
typedef struct _iscAppConfigFlds {
    ...
    **/
#ifdef _MSC_VER
    BFld LimitMode : 3;                     //  12-14 Limit switch mode
#else
...
typedef union _iscTuneConfigReg {
    ...
    struct _iscTuneConfigFlds {
        ...
        **/
#ifdef _MSC_VER
        BFld AntiHunt : 2;              // 0-1 Anti-hunt modes
#else
...
typedef struct PACK_BYTES _drvNonAttnFlds
{
    ...
    **/
    ...
    /**
        ...
        The node has completed its homing sequence.
    **/
    BFld HomingComplete : 1;    // 12 44: Homing sequence complete
    /**
...
typedef struct _iscAttnFlds {           // Attentionable 24-bits of status
    ...
    **/
    ...
    /**
        ...
        This bit asserts when the <i>IEX Status Register</i>
        (#ISC_P_IEX_STATUS) changes.
...
typedef struct PACK_BYTES _iscAlertFlds
{
    ...
    **/
    ...
    /**
        ...
        General Purpose Output overload detector defective.
    ...
    **/
    ...
    /**
        ...
        - Defective motor.
    **/
    BFld MtrEncGlitch            : 1; /* 60 */ // Motor encoder glitch
    /**
...
This is recoverable when the bus voltage has returned to a safe level.
    ...
    **/
    ...
    BFld na94                    : 1; /* 94 */
    BFld AbsPosnIndexErr         : 1; /* 95 */ // The index for 16 Abs Posn mode is out of bounds
} iscAlertFlds;
/// \endcond                                                                  *
//*****************************************************************************
...
typedef PACK_BYTES struct _iscMoveProfiledExlPacket {
    int style : 16;  // Format of move (mgPosnStyle)
    int value : 32;  // Distance of the motion
} iscMovePosnExlPacket;
#ifdef _MSC_VER
